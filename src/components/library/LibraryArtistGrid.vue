...
import type { LibraryArtist, ArtistGroup, LibraryDisplayMode } from "./types";
    ...
    <ScrollArea class="size-full">
      <div class="px-7 py-6">
        ...
        >
          ...
          <div
            :class="
              props.displayMode === 'grid' ? 'library-grid' : 'grid gap-2'
            "
          >
            <article
              ...
              :class="
                props.displayMode === 'list' ? 'flex items-center gap-3' : ''
              "
